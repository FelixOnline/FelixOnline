...
CREATE TABLE `article` (
  ...
  KEY `hidden` (`hidden`),
  CONSTRAINT `article_ibfk_19` FOREIGN KEY (`author`) REFERENCES `user` (`user`),
  CONSTRAINT `article_ibfk_21` FOREIGN KEY (`img2`) REFERENCES `image` (`id`),
  CONSTRAINT `article_ibfk_22` FOREIGN KEY (`approvedby`) REFERENCES `user` (`user`),
  CONSTRAINT `article_ibfk_24` FOREIGN KEY (`text1`) REFERENCES `text_story` (`id`),
  CONSTRAINT `article_ibfk_25` FOREIGN KEY (`text2`) REFERENCES `text_story` (`id`),
  CONSTRAINT `article_ibfk_26` FOREIGN KEY (`category`) REFERENCES `category` (`id`) ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=80008155 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-02-11 21:45:02
