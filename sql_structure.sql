...
--
-- Host: localhost
-- Generation Time: Feb 03, 2012 at 04:09 PM
...
CREATE TABLE IF NOT EXISTS `comment_ext` (
  ...
  KEY `article` (`article`),
  KEY `pending` (`pending`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=80008132 ;
...
CREATE TABLE IF NOT EXISTS `text_story` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1508 ;
