...
<div class="article-block section <?php echo $article->getCategory()->getCat(); ?>">
	<div class="tiny"<?php if($equalizer): ?> data-equalizer-watch="<?php echo $equalizer; ?>"<?php endif; ?>>
		...
		<?php if($comments > 0): ?><span class="article-inline-comments <?php echo $article->getCategory()->getCat(); ?>"><a href="<?php echo $article->getUrl(); ?>#commentHeader"><span class="glyphicons glyphicons-comments"></span>&nbsp;<?php echo $comments; ?></a></span><?php endif; ?>
