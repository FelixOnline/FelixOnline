...
$this->resources = new Core\ResourceManager(
	...
	/* JS files */
	array('jquery.min.js', 'what-input.min.js', 'foundation.min.js', 'fastclick.js', 'jquery.cookie.js', 'jquery.placeholder.js', 'slick.min.js', 'jquery-visible.js', 'script.js', 'rrssb.min.js', 'jquery.waitforimages.min.js')
);
