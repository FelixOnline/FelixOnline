	...
	$.fn.ticker = function(options) { 
		...
		return this.each(function() { 
			...
			function initialisePage() {
				...
				$(settings.dom.wrapperID).append('<div id="' + settings.dom.tickerID.replace('#', '') + '"><a href="http://twitter.com/feliximperial" title="Felix on Twitter"><div id="' + settings.dom.titleID.replace('#', '') + '"><span style="display: none;"><!-- --></span></div></a><p id="' + settings.dom.contentID.replace('#', '') + '"></p><div id="' + settings.dom.revealID.replace('#', '') + '"><span style="display: none;"><!-- --></span></div></div>');
