				...
				<div class="felix-contact-area">
					<div class="row felix-contact-row">
						<div class="small-3 columns">
							<a href="mailto:<?php echo $category->getEmail(); ?>"><img src="<?php echo STANDARD_URL.'themes/'.\FelixOnline\Core\Settings::get('current_theme').'/'; ?>img/email.png"></a>
						</div>
					...
					<div class="row felix-contact-row">
						<div class="small-3 columns">
							<a href="http://twitter.com/<?php echo $category->getTwitter(); ?>"><img src="<?php echo STANDARD_URL.'themes/'.\FelixOnline\Core\Settings::get('current_theme').'/'; ?>img/twitter.png"></a>
						</div>
						<div class="small-9 columns">
